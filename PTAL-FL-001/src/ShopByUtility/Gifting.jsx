...
//           From Rs. {typeof product.price === "string" ? product.price : product.price.toLocaleString()}
//         </p>
//       </div>
...
//   return (
//     <div className="bg-[#f9f6f1] min-h-screen py-10 px-4">
//       <h2 className="text-5xl font-serif text-center text-[#a42c2a] mb-8">Gifting</h2>
