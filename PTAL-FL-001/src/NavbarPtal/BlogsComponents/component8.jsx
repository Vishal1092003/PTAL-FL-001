...
export default function Component8() {
  ...
  return (
    <div className="bg-[#fdf8ef] text-black px-4 md:px-16 py-10 font-sans leading-relaxed">
      ...
      <p className="text-center text-sm mb-4">Jan 03, 2022</p>
      ...
      <div className="flex flex-wrap items-center justify-center gap-8 my-12">
        <div className="flex justify-center">
          <img
            src="/blogSectionImages/component8img1.webp"
            alt="Traditional Indian home with kitchenware"
            className="rounded-lg shadow-lg w-full max-w-xl"
          />
        </div>
        <div className="flex justify-center">
          <img
            src="/blogSectionImages/component8img2.webp"
            alt="Traditional Indian home with kitchenware"
            className="rounded-lg shadow-lg w-full max-w-xl"
          />
        </div>
      ...
      <div className="max-w-4xl mx-auto text-lg space-y-6">
        <p>{t("blogComponent8.p2")}</p>
        <div className="flex flex-wrap items-center justify-center gap-8 my-12">
          <div className="flex justify-center">
            <img
              src="/blogSectionImages/component8img3.webp"
              alt="Traditional Indian home with kitchenware"
              className="rounded-lg shadow-lg w-full max-w-xl"
            />
          </div>
          <div className="flex justify-center">
            <img
              src="/blogSectionImages/component8img4.webp"
              alt="Traditional Indian home with kitchenware"
              className="rounded-lg shadow-lg w-full max-w-xl"
            />
          </div>
        </div>
        <p>{t("blogComponent8.p4")}</p>

        <div className="flex justify-center my-12">
          <img
            src="/blogSectionImages/component8img6.webp"
            alt="Family cooking together with traditional utensils"
            className="rounded-lg shadow-lg w-full max-w-xl"
          />
        </div>

        <p>{t("blogComponent8.p5")}</p>
        ...
        <p className="text-center text-lg">{t("blogComponent8.p7")}</p>
      </div>
