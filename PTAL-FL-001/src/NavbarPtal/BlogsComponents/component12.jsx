...
export default function Component12() {
  ...
  return (
    <div className="bg-[#fdf8ef] text-black px-4 md:px-16 py-10 font-sans leading-relaxed">
      ...
      >
        {t("blogComponent12.title")}
      </h1>
      <h2 className="text-2xl text-center mb-8 italic">
        {t("blogComponent12.subtitle")}
      </h2>

      {/* Intro Text */}
      <div className="max-w-4xl mx-auto text-lg space-y-4">
        <p>{t("blogComponent12.p1")}</p>
        <p>{t("blogComponent12.p2")}</p>
      </div>

      {/* Image */}
      <div className="flex justify-center my-12">
        <img
          src="/blogSectionImages/component12img1.png"
          alt="Bride with natural glow"
      ...
      <div className="max-w-4xl mx-auto text-lg space-y-6">
        <h2
          ...
          style={{ fontFamily: "Fondamento, cursive" }}
        >
          {t("blogComponent12.h3")}
        </h2>
        <p>{t("blogComponent12.p3")}</p>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-8">
          <div className="text-center">
            <img
              src="/blogSectionImages/component12img2.jpg"
              alt="Kansa Dinner Set"
              className="rounded-lg shadow-lg w-full mb-4"
            />
            <h3 className="font-semibold">{t("blogComponent12.img1")}</h3>
          </div>
          <div className="text-center">
            <img
              src="/blogSectionImages/component12img3.png"
              alt="Traditional cookware"
              className="rounded-lg shadow-lg w-full mb-4"
            />
            <h3 className="font-semibold">{t("blogComponent12.img2")}</h3>
          </div>
        </div>

        <p>{t("blogComponent12.p4")}</p>
        <p>{t("blogComponent12.p5")}</p>

        <div className="bg-amber-50 p-6 rounded-lg my-8">
          <h3 className="text-xl font-semibold text-center mb-4">
            {t("blogComponent12.h6")}
          </h3>
          <p>{t("blogComponent12.p6")}</p>
        </div>
        ...
        <h2
          ...
          style={{ fontFamily: "Fondamento, cursive" }}
        >
          {t("blogComponent12.h7")}
        </h2>
        <p>{t("blogComponent12.p7")}</p>

        <div className="flex justify-center my-12">
          <img
            src="/blogSectionImages/component12img4.png"
            alt="Assamese wedding tradition"
            className="rounded-lg shadow-lg w-full max-w-xl"
          />
        </div>

        <p className="text-center italic mb-4">{t("blogComponent12.img3")}</p>

        <p>
          {t("blogComponent12.p8")}
          glass.
        </p>
        <p>{t("blogComponent12.p9")}</p>
      </div>
