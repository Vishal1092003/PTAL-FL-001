...
export default function Component2() {
  ...
  return (
    <div className="bg-[#fdf8ef] text-black px-4 md:px-16 py-10 font-sans leading-relaxed">
      ...
      >
        {t("blogComponent13.title")}
      </h1>

      {/* Main Content */}
      <div className="max-w-4xl mx-auto text-lg space-y-6">
        <p>{t("blogComponent13.p1")}</p>
        <p>{t("blogComponent13.p2")}</p>

        <h2
          className="text-2xl mt-8"
          style={{ fontFamily: "Fondamento, cursive" }}
        >
          {t("blogComponent13.h3")}
        </h2>
        <p>{t("blogComponent13.p3")}</p>

        <h2
          className="text-2xl mt-8"
          style={{ fontFamily: "Fondamento, cursive" }}
        >
          {t("blogComponent13.h4")}
        </h2>
        <p>{t("blogComponent13.p4")}</p>

        <h2
          className="text-2xl mt-8"
          style={{ fontFamily: "Fondamento, cursive" }}
        >
          {t("blogComponent13.h5")}
        </h2>
        <p>{t("blogComponent13.p5")}</p>
        <div className="flex flex-col md:flex-row justify-center items-center gap-8 my-12">
          {/* Left column: Vertical stack of two images */}
          <div className="flex flex-col gap-8">
            <img
              src="/blogSectionImages/component13img1.png"
              alt="Bride with natural glow"
              className="rounded-lg shadow-lg w-full max-w-xs md:max-w-sm"
            />
            <img
              src="/blogSectionImages/component13img3.jpg"
              alt="Bride with natural glow"
              className="rounded-lg shadow-lg w-full max-w-xs md:max-w-sm"
            />
          </div>
          ...
          <div>
            <img
              src="/blogSectionImages/component13img2.jpg"
              alt="Bride with natural glow"
        ...
        <p>{t("blogComponent13.p6")}</p>

        <h2
          className="text-2xl mt-8"
          style={{ fontFamily: "Fondamento, cursive" }}
        >
          {t("blogComponent13.h7")}
        </h2>
        <p>{t("blogComponent13.p7")}</p>
        <p>{t("blogComponent13.p8")}</p>
        <p>{t("blogComponent13.p9")}</p>
        <p>{t("blogComponent13.p10")}</p>
        <p>{t("blogComponent13.p11")}</p>
      </div>
