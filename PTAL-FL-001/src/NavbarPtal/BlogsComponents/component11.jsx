...
export default function Component11() {
  ...
  return (
    <div className="bg-[#fdf8ef] text-black px-4 md:px-16 py-10 font-sans leading-relaxed">
      ...
      >
        {t('blogComponent11.title')}
      </h1>

      {/* Intro Text */}
      <div className="max-w-4xl mx-auto text-lg space-y-4">
        <p>
          {t('blogComponent11.p1')}
        </p>
        <p>
          {t('blogComponent11.p2')}
        </p>
      </div>
      ...
      <div className="flex justify-center my-12">
        <img
          src="/blogSectionImages/component11img1.jpg"
      ...
      <div className="max-w-4xl mx-auto text-lg space-y-6">
        <p>
          {t('blogComponent11.p3')}
        </p>

        <div className="flex justify-center my-12">
          <img
            src="/blogSectionImages/component11img2.jpg"
            alt="Brass Paraat Clock"
            className="rounded-lg shadow-lg w-full max-w-xl"
          />
        </div>
        ...
        <h2
          ...
          style={{ fontFamily: "Fondamento, cursive" }}
        >
       {t('blogComponent11.h4')}
        </h2>
        <p>
          {t('blogComponent11.p4')}
        </p>
        <p>
          {t('blogComponent11.p5')}
        </p>
        ...
        <h2
          ...
          style={{ fontFamily: "Fondamento, cursive" }}
        >
          {t('blogComponent11.h6')}
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-8">
          <div className="border-l-2 border-red-600 pl-4">
            
            <p>{t('blogComponent11.p6')}</p>
          </div>
          <div className="border-l-2 border-red-600 pl-4">
            
            <p>{t('blogComponent11.p7')}</p>
          </div>
          <div className="border-l-2 border-red-600 pl-4">
            
            <p>
              {t('blogComponent11.p8')}
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-center my-12">
          <img
            src="/blogSectionImages/component11img3.jpg"
            alt="Thathera artisans at work"
            className="rounded-lg shadow-lg w-full max-w-xl"
          />
        </div>

        <p>
          {t('blogComponent11.p9')}
        </p>
        <p>
         {t('blogComponent11.p10')}
        </p>

        <blockquote className="border-l-4 border-red-600 pl-4 italic my-6">
          {t('blogComponent11.p11')}
        </blockquote>

        <p>
          {t('blogComponent11.p12')}
        </p>
        <p>
          {t('blogComponent11.p13')}
        </p>
      </div>
