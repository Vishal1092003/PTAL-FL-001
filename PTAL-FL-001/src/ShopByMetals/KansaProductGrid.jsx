...
// export default function KansaProductGrid() {
...
//             ))}
//           </div>
//           <span>{product.reviews} {t('kansa_product_grid.reviews')}</span>
//         </div>
...
//         {/* Price */}
//         <p className="text-sm font-medium text-black">
//           {t('kansa_product_grid.from_price', { price: product.price.toLocaleString() })}
//         </p>
//       </div>
...
//           } text-white`}
//       >
//         {isAdded ? t('kansa_product_grid.added_to_cart') : t('kansa_product_grid.add_to_cart')}
//       </button>
//     </div>
//   );
// };
...
//   const sortOptions = [
//     { key: "Featured", label: t('kansa_product_grid.sort_options.featured') },
//     { key: "Alphabetically, A-Z", label: t('kansa_product_grid.sort_options.alphabetically_a_z') },
//     { key: "Alphabetically, Z-A", label: t('kansa_product_grid.sort_options.alphabetically_z_a') },
//     { key: "Price, low to high", label: t('kansa_product_grid.sort_options.price_low_to_high') },
//     { key: "Price, high to low", label: t('kansa_product_grid.sort_options.price_high_to_low') },
//   ];
...
//           {products.length} {t('kansa_product_grid.products')}
//         </h2>
//         <select
//           value={sortType}
//           onChange={(e) => {
...
//           className="border border-gray-300 rounded px-4 py-2 bg-white text-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-[#8b0000] transition-all"
//         >
//           <option disabled>{t('kansa_product_grid.sort')}</option>
//           {sortOptions.map((option) => (
...
//         <p className="text-sm font-medium text-black">
//           {t('kansa_product_grid.from_price', { 
...
const ProductCard = ({ product, onAddToCart }) => {
  ...
  return (
    ...
    >
      ...
      {/* Add to cart button fixed to bottom 5px */}
      <button
        onClick={handleAddToCart} // Updated to use new handler
        disabled={isAdded}
        className={`absolute left-4 right-4 bottom-[5px] py-2 w-auto text-sm font-bold rounded-full transition-all duration-300
          ${isAdded 
            ? 'bg-green-600 cursor-not-allowed' 
