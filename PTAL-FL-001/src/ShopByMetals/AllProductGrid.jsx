...
//       (item) => {
//         const productClass = item.class.toLowerCase();
//         return productClass === "brass" || productClass === "copper" || productClass === "kansa";
//       }
//     );
...
//             ))}
//           </div>
//           <span>{product.reviews} {t('all_product_grid.reviews')}</span>
//         </div>
...
//         {/* Price */}
//         <p className="text-sm font-medium text-black">
//           {t('all_product_grid.from_price', { price: product.price.toLocaleString() })}
//         </p>
//       </div>
...
//           } text-white`}
//       >
//         {isAdded ? t('all_product_grid.added_to_cart') : t('all_product_grid.add_to_cart')}
//       </button>
//     </div>
//   );
// };
...
//   const sortOptions = [
//     { key: "Featured", label: t('all_product_grid.sort_options.featured') },
//     { key: "Alphabetically, A-Z", label: t('all_product_grid.sort_options.alphabetically_a_z') },
//     { key: "Alphabetically, Z-A", label: t('all_product_grid.sort_options.alphabetically_z_a') },
//     { key: "Price, low to high", label: t('all_product_grid.sort_options.price_low_to_high') },
//     { key: "Price, high to low", label: t('all_product_grid.sort_options.price_high_to_low') },
//   ];
...
//           {products.length} {t('all_product_grid.products')}
//         </h2>
//         <select
//           value={sortType}
//           onChange={(e) => {
...
//           className="border border-gray-300 rounded px-4 py-2 bg-white text-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-[#8b0000] transition-all"
//         >
//           <option disabled>{t('all_product_grid.sort')}</option>
//           {sortOptions.map((option) => (
...
const ProductCard = ({ product, onAddToCart }) => {
  ...
  const getTranslatedProduct = (productId) => {
    return {
      name: t(`products.${productId}.name`, { defaultValue: product.name }),
      price: parseFloat(t(`products.${productId}.price`, { defaultValue: product.price.toString() }))
    };
  };
