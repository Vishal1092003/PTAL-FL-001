...
//           >
//             Key Benefits Of Kansa Ke Bartan
//           </h2>
...
//             style={{ fontFamily: "'Fontamento', cursive" }}
//           >
//             Pure Kansa ke bartan at Reasonable Price
//           </h2>
//           <p className="text-lg leading-relaxed">
      ...
      <div className="bg-[#f9f4ec] px-6 md:px-20 py-16 text-[#1e1e1e]">
        ...
        <div className="mb-16">
          <h2
            ...
            style={{ fontFamily: "'Fontamento', cursive" }}
          >
            {t('kansa.benefits.title')}
          </h2>
          <p className="text-lg leading-relaxed">
            {t('kansa.benefits.description')}
          </p>
        </div>
        ...
        <div className="mb-16">
          <h2
            ...
            style={{ fontFamily: "'Fontamento', cursive" }}
          >
            {t('kansa.pricing.title')}
          </h2>
          <p className="text-lg leading-relaxed">
            {t('kansa.pricing.description')}
          </p>
        </div>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-4">
            {t('kansa.additional_benefits.title')}
          </h2>
          <p className="text-lg leading-relaxed">
            {t('kansa.additional_benefits.description')}
          </p>
        </div>
        ...
        <div>
          <h2 className="text-3xl font-bold mb-4">
            {t('kansa.pure_kansa.title')}
          </h2>
          <p className="text-lg leading-relaxed">
            {t('kansa.pure_kansa.description')}
          </p>
        </div>
      </div>
    </div>
