      ...
      <div className="flex items-center justify-center min-h-screen bg-gray-100 px-2">
        <div className="w-full max-w-sm md:max-w-md bg-white shadow-lg p-6 rounded-2xl">
          ...
          <div className="max-w-sm mx-auto space-y-4 text-center">
            ...
            <button
              className="
          w-full
          bg-gradient-to-r from-red-800 via-fuchsia-500 to-purple-600
          text-white
          font-extrabold
          py-3
          rounded-2xl
          hover:from-red-900 hover:via-fuchsia-600 hover:to-purple-700
        ...
        "
            ...
            <button
              className="
          w-full
          bg-gradient-to-r from-orange-400 via-yellow-300 to-red-800
          text-white
          font-bold
          py-3
          rounded-2xl
          hover:from-orange-500 hover:via-yellow-400 hover:to-red-900
