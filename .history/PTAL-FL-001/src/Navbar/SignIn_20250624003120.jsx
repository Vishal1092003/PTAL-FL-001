...
//         <div className="w-[450px] h-[500px] bg-white shadow-lg p-6 rounded-2xl">
//           <div className="text-center text-xl font-semibold text-gray-800 mb-3">
//             SIGN IN to p-TAL
//           </div>

//           <div
//             className="text-center text-7xl text-red-800 mb-4"
...
//             </button>
//             <br />
//             <button className="underline mt-2 hover:text-red-500 transition duration-200">
//               FORGOT PASSWORD?
//             </button>
//             <br />
//             <button className="underline mt-2 hover:text-red-500 transition duration-200">
