...
//     ptal: true, // P-TAL section initially open
//     metals: false, // Shop By Metals initially closed
//     utility: false, // Shop By Utility initially closed
//   });
...
//           ✨ Free shipping on orders all over India! ✨
//         </div>
//       </div>
...
//       <div
//         ref={navbarRef}
//         className={`transition-all duration-500 ease-in-out px-3 sm:px-6 lg:px-10 text-[#B01C1A] overflow-visible z-50 w-full backdrop-blur-sm
//           ${
...
//         <div className="flex justify-between items-center h-[70px] sm:h-[90px] gap-2 sm:gap-4">
//           {/* Left: Enhanced Hamburger/Cross + SHOP */}
//           <div
//             ref={shopButtonRef}
...
//           <div className="flex gap-3 sm:gap-4 lg:gap-6 xl:gap-8 items-center flex-shrink-0 ml-auto">
//             <div className="relative">
//               <button 
...
//                     {[
//                       { to: "/home", text: "Home" },
//                       { to: "/NavbarPtal/AboutUs", text: "About Us" },
//                       {
//                         to: "/NavbarPtal/StoryOfOurArtisans",
//                         text: "Story of Our Artisans",
//                       },
//                       {
//                         to: "/NavbarPtal/KalaiKit",
//                         text: "Kalai (Tin Coating) Kit",
//                       },
                      
//                       { to: "/NavbarPtal/Faqs", text: "FAQs" },
//                       { to: "/NavbarPtal/ContactUs", text: "Contact Us" },
//                       { to: "/NavbarPtal/Blogs", text: "Blogs" },
//                       { to: "/NavbarPtal/RetailStores", text: "Retail Stores" },
...
//                   <ul className="space-y-0.5 sm:space-y-1 grid grid-cols-1 sm:grid-cols-2 gap-x-3 sm:gap-x-4 gap-y-1 sm:gap-y-1.5">
//                     {[
//                       { to: "/ShopByMetals/All", text: "All" },
//                       { to: "/ShopByMetals/Brass", text: "Brass" },
//                       { to: "/ShopByMetals/Copper", text: "Copper" },
//                       { to: "/ShopByMetals/Kansa", text: "Kansa" },
//                       {
//                         to: "/ShopByMetals/PopularProducts",
...
//                     {[
//                       {
//                         to: "/ShopByUtility/AsSeenOnTV",
//                         text: "As Seen on TV",
//                       },
//                       {
//                         to: "/ShopByUtility/CookwareAndKitchenware",
//                         text: "Cookware & Kitchenware",
//                       },
//                       { to: "/ShopByUtility/Drinkware", text: "Drinkware" },
                      
//                       {
//                         to: "/ShopByUtility/SetsAndCombos",
//                         text: "Sets and Combos",
//                       },
//                       { to: "/ShopByUtility/Gifting", text: "Gifting" },
...
//               </div>
//             </div>
//             {/* Desktop layout - Enhanced side by side columns */}
...
//                         onClick={handleLinkClick}
//                         onMouseEnter={() =>
//                           handleItemHover(`desktop-ptal-${index}`)
//                         }
//                         onMouseLeave={handleItemLeave}
//                       >
//                         <span
...
//                         onClick={handleLinkClick}
//                         onMouseEnter={() =>
//                           handleItemHover(`desktop-metals-${index}`)
//                         }
//                         onMouseLeave={handleItemLeave}
//                       >
//                         <span
...
//                 <ul className="space-y-2">
//                   {[
//                     { to: "/ShopByUtility/AsSeenOnTV", text: "As Seen on TV" },
//                     {
//                       to: "/ShopByUtility/CookwareAndKitchenware",
//                       text: "Cookware & Kitchenware",
//                     },
...
//                         onClick={handleLinkClick}
//                         onMouseEnter={() =>
//                           handleItemHover(`desktop-utility-${index}`)
//                         }
//                         onMouseLeave={handleItemLeave}
//                       >
//                         <span
...
//         className="fixed bottom-4 sm:bottom-6 right-4 sm:right-6 z-50 transition-all duration-300 hover:scale-125 hover:shadow-2xl"
...
//   // Toggle language and update document direction
...
//   return (
//     <div className={`relative ${i18n.language === 'ar' ? 'rtl' : 'ltr'}`}>
//       {/* Top Banner with enhanced styling */}
//       <div className="h-10 sm:h-12 bg-gradient-to-r from-yellow-400 via-yellow-300 to-yellow-400 flex justify-center items-center text-xs sm:text-sm md:text-base text-[#B01C1A] font-semibold shadow-md px-4">
//         <div className="animate-pulse text-center">
//           {t('navbar.banner')}
...
//                             className={`transition-all duration-300 ${
//                               hoveredItem === `ptal-${index}`
//                                 ? i18n.language === 'ar' ? "translate-x-[-0.25rem] sm:translate-x-[-0.375rem]" : "translate-x-1 sm:translate-x-1.5"
//                                 : ""
//                             }`}
//                           >
//                             {item.text}
...
//                           className={`transition-all duration-300 ${
//                             hoveredItem === `desktop-ptal-${index}`
//                               ? i18n.language === 'ar' ? "translate-x-[-0.5rem]" : "translate-x-2"
//                               : ""
//                           }`}
//                         >
//                           {item.text}
